...
const LoginPage = ({ onLogin }) => (
  <div className="flex items-center justify-center min-h-screen login-bg p-4">
    <div className="w-full max-w-md bg-slate-100 p-8 rounded-2xl shadow-2xl fade-in">
      ...
      <h2 className="text-2xl font-bold text-center text-slate-800 mb-2">Sistema de Reservas</h2>
      <p className="text-center text-slate-600 mb-8">Acesso apenas para colaboradores</p>
      <form onSubmit={onLogin} className="space-y-6">
        <div>
          <label htmlFor="email" className="block text-sm font-semibold text-slate-700 mb-2">Email Corporativo</label>
          <input type="email" id="email" className="w-full p-3 bg-slate-200 border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="nome.sobrenome@cmc.com.br" required />
        </div>
        <div>
